 ...
 *  @author  dodge <dodgepudding@gmail.com> (original <https://github.com/dodgepudding/wechat-php-sdk>)
 *  @link https://github.com/Ax0T/wechat-php
 *  @version 0.1
 */
...
class Wechatext
{
        ...
        public function sendPreview($account,$title,$summary,$content,$photoid,$srcurl='') {
                ...
                $submit = "https://mp.weixin.qq.com/cgi-bin/operate_appmsg";
                $send_snoopy->set_submit_normal();
                $send_snoopy->rawheaders['Cookie']= $this->cookie;
        ...
        public function saveCookie($filename,$content){
                $cookie=array('time'=>time(),
                        'content'=>$content);
                return $this->_kv->set($filename,$cookie);
        }
